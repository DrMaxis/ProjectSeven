...
/*
 * All configuration options for Project Seven
 *
 */
...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Configurations related to the app's access/authorization options
    */
    'access' => [
        'captcha' => [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configurations related to the project's avatar system
    */
    'avatar' => [
    ...
    |--------------------------------------------------------------------------
    |
    | Configurations related to the project's locale system
    */
    'locale' => [
        /*
